...
if __name__ == '__main__':
    ...
    checkpoint_path = os.path.join(MODEL_DIR, "Transformer_RC_Encoder_{}".format(RC_ENC_N))
    ...
    for _, val_proc_path in enumerate(iglob(os.path.join(src_data_path, '**.csv'), recursive=False)):
        ...
        saveCSVFile(TRANS_RC_ENC_PREDICT_PATH, media_name, validation_generated_dist)